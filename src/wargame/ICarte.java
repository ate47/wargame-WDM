...
public interface ICarte {
	 ...
	 * 
	 * @param relativePosX la position relative X
	 * @param relativePosY la position relative X
	 * @param unit         l'unité de taille
	...
	/**
	 * retourne vrai si la traversé entre les deux points est valide (qu'il n'y a
	 ...
	 * {@link ICarte#visible(int, int, int, boolean, ICase[])}
	 * 
	 * @param x        coord x de la position
	 * @param y        coord y de la position
	 * @param portee   la portee a regarder
	 * @param colision si on calcul les colisions
	 ...
	 * @param y        coord y de la position
	 * @param portee   la portee a regarder
	 * @param cases    le tableau où stocker les cases, il doit faire au moins la
	 *                 taille decrite avec {@link ICarte#nombreVisible(int)}
	 * @param colision si on calcul les colisions
